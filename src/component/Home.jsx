    ...
    return (
        <>
            <div className='container mx-auto'>
                ...
                <div className=" flex md:flex-col flex-col my-4  lg:ms-[700px] md:ms-[700px] sm:ms-[500px]  p-2 h-fit md:w-[600px] w-full">

                    <div className='h-fit md:w-[600px] w-full brightness-100 bg-white rounded-xl absolute  md:top-[500px]  p-4 '>
                        <div className=''>
            ...
            <div className='flex md:flex-row flex-col justify-evenly md:my-3 my-[300px] container mx-auto'>
            ...
            <ScrollTrigger onEnter={() => setcountOn(true)} onExit={() => setcountOn(false)}>
                ...
                <div className='flex md:flex-row flex-col justify-between  p-7 pt-11 pb-11 container mx-auto'>
